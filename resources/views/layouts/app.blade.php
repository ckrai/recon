<?php
 if(!(\Auth::user()->role =='admin' || \Auth::user()->role =='management' ||\Auth::user()->role == 'viewer')){
                    ...
                    <div class="aside-nav d-flex flex-column align-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
                        ...
                        @if(\Auth::user()->role=='admin' || \Auth::user()->role=='management') 
                            ...
                            <div class="menu-item py-2">
                                <a class="menu-link  menu-center <?php if( Route::currentRouteName() =='dashboard'){ echo 'active' ;} ?>" href="{{url('dashboard')}}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            ...
                            <div class="menu-item py-2">
                                <a class="menu-link menu-center <?php if( Route::currentRouteName() =='surveys'){ echo 'active' ;} ?>" title="Surveys" href="{{url('surveys')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon me-0">
                             ...
                             <div class="menu-item py-2">
                                <a class="menu-link menu-center <?php if( Route::currentRouteName() =='surveyors'){ echo 'active' ;} ?>" title="Surveyors" href="{{url('surveyors')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon me-0">
                           ...
                           @if(\Auth::user()->role=='admin') 
                            ...
                            @if(\Auth::user()->role=='admin') 
                            <div class="menu-item py-2">
                                <a  href="{{url('settings')}}"class="menu-link menu-center <?php if( Route::currentRouteName() =='settings'){ echo 'active' ;} ?>" title="Settings" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon me-0">
                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center" id="kt_header_wrapper">
                                ...
                                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                                    <!--begin::Heading-->
                                    <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">{{ ucfirst(Route::currentRouteName()) }}</h1>
                                    <!--end::Heading-->
                                </div>
                                <!--end::Page title=-->
                            </div>
                                    ...
                                    <div class="d-flex align-items-stretch flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                            ...
                                            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                                                <img style="width:110px; height: 40px;" src="{{url('')}}/assets/media/avatars/upicon logo22.png" alt="metronic" />
                                            </div>
                                            <!--begin::Menu-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <div class="menu-content d-flex align-items-center px-3">
                                                        ...
                                                        <div class="symbol symbol-50px me-5">
                                                            <img style="width:80px; height: 30px;" alt="Logo" src="{{url('')}}/assets/media/avatars/upicon logo22.png" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Username-->
